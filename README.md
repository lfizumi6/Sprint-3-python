...
- `pandas`: responsável pela leitura e gravação dos arquivos CSV.
- `matplotlib`: responsável pela criação dos gráficos de análise.
- `Counter`: módulo da biblioteca padrão do Python, utilizado para contar frequências dos dados.
